  ...
  try {
    ...
    if (input === 'kroketprompts') {
      ...
      const GEHEIME_COMMANDO_S = [
        { categorie: '📊 Scores & leden' },
        { cmd: 'ranglijst',                       uitleg: 'scorebord van alle leden' },
        { cmd: 'status',                          uitleg: 'leden, scores, bans en allianties live uit de database' },
        { cmd: 'dossier [naam]',                  uitleg: 'volledig kroket-CV: punten, streak, bans, motto, zonden' },
        { cmd: 'streaks',                         uitleg: 'ranglijst vrijdag-deelnamestreaks met records' },
        { cmd: 'stem [naam]',                     uitleg: 'stem op Held van de Week (1x per week)' },
        { cmd: 'eer [naam] (voor [reden])',        uitleg: '1–2 kroketpunten — alliantie-partner krijgt 50% kans op bonuspunt' },
        { cmd: 'zondebok',                        uitleg: '−1 punt bij willekeurig lid' },

        { categorie: '⚖️ Recht & orde' },
        { cmd: 'gelekaart [naam] [reden]',        uitleg: 'formele waarschuwing — tweede overtreding = directe ban (4→8→24→48u)' },
        { cmd: 'begenade [naam]',                 uitleg: 'verbanning direct opheffen' },
        { cmd: 'beroep [smoes]',                  uitleg: '20% kans op vrijheid (35% met actieve alliantie) — 80% extra vernedering' },
        { cmd: 'uitbreken',                       uitleg: '20% ontsnapping — 80% ban +1u — max 1x/uur' },
        { cmd: 'klacht [naam] [beschrijving]',    uitleg: 'anonieme aanklacht — 15% kans dat jij ontmaskerd wordt' },
        { cmd: 'meld [naam]',                     uitleg: 'meld iemand als vijand van de snackleer' },
        { cmd: 'rechtbank [naam] vs [naam]',      uitleg: 'rechtszaak — Kroket God als rechter én aanklager' },

        { categorie: '⚔️ Allianties' },
        { cmd: 'alliantie [naam]',                uitleg: 'heilig verbond — gedeelde eer, pactbescherming bij beroep, solidariteitsbonus bij achievements' },
        { cmd: 'alliantie verbreek',              uitleg: 'beëindig uw huidige verbond' },
        { cmd: 'alliantie overzicht',             uitleg: 'alle actieve verbonden in de Illuminati' },

        { categorie: '🌍 Echte data & API\'s' },
        { cmd: 'weer',                            uitleg: 'echt Amsterdams weer (temp, wind, neerslag) + zonsopkomst/ondergang + maanfase' },
        { cmd: 'feitje',                          uitleg: 'echt feit via Wikipedia NL (40%) of absurd weetje (15%) of AI (45%)' },
        { cmd: 'mop',                             uitleg: 'echte mop via JokeAPI — onvertaald' },
        { cmd: 'quiz',                            uitleg: 'trivia-vraag uit Open Trivia Database — antwoord volgt na 30 seconden' },
        { cmd: 'advies',                          uitleg: 'echt levensadvies via Advice Slip API — gepresenteerd als goddelijk decreet' },
        { cmd: 'bs',                              uitleg: 'echt corporate jargon als heilige openbaring' },
        { cmd: 'orakel [vraag]',                  uitleg: 'cryptisch antwoord — 40% gebaseerd op echt advies uit Advice Slip' },
        { cmd: 'frituur [beschrijving]',          uitleg: 'AI-afbeelding via Gemini — willekeurige kunststijl' },

        { categorie: '🎭 Vaste formats' },
        { cmd: 'biecht [zonde]',                  uitleg: 'openbare of privé (DM) biecht — wordt opgeslagen in weeklog' },
        { cmd: 'horoscoop [naam]',                uitleg: 'persoonlijke kroket-horoscoop voor de week' },
        { cmd: 'hoelang',                         uitleg: 'wiskundige aftelling tot vrijdag 12:00 in creatieve eenheden' },
        { cmd: 'vrijdag',                         uitleg: 'countdown of viering afhankelijk van het tijdstip' },
        { cmd: 'slachtoffer',                     uitleg: 'score-gewogen willekeurig lid — zegen of dreigement' },
        { cmd: 'gebod [1-10]',                    uitleg: 'toelichting op een van de Tien Geboden' },
        { cmd: 'straf [naam]',                    uitleg: 'creatieve straf voor lid of buitenstaander' },
        { cmd: 'bekeer [naam]',                   uitleg: 'oordeel of een buitenstaander de Illuminati waardig is' },
        { cmd: 'debat [stelling]',                uitleg: 'voor/tegen + definitief vonnis' },
        { cmd: 'kroket vs bitterbal',             uitleg: 'het finale eeuwenoude debat' },
        { cmd: 'nieuws',                          uitleg: 'breaking news uit het Vetbad' },
        { cmd: 'quote',                           uitleg: 'kroket-wijsheid in één zin' },
        { cmd: 'weekoverzicht',                   uitleg: 'dramatisch weekoverzicht op basis van opgeslagen events' },

        { categorie: '✍️ Creatief schrijven' },
        { cmd: 'rap [onderwerp]',                 uitleg: '4-8 regels met rijm en kroket-metaforen' },
        { cmd: 'schrijf een kroket-lied op de melodie van [liedje]', uitleg: '2 coupletten + refrein met rijm' },
        { cmd: 'schrijf een kroket-testament voor [naam]',           uitleg: '3 nalatenschappen in juridische kroket-taal' },
        { cmd: 'schrijf een necrologie voor een mislukte kroket',    uitleg: 'waardig rouwbericht voor een kroket die het niet haalde' },
        { cmd: 'schrijf een kroket-sollicitatiebrief voor [naam]',   uitleg: 'motivatiebrief voor de Hoge Frituurraad' },
        { cmd: 'schrijf een kroket-huwelijksaanzoek',                uitleg: 'romantisch aanzoek van volgeling aan de frituurcultuur' },
        { cmd: 'schrijf een kroket-horrorscenario',                  uitleg: 'wereld zonder kroketten of invasie van de Saladesekte' },
        { cmd: 'schrijf een encycliek over [thema]',                 uitleg: 'pauselijke decreten in quasi-religieuze taal' },

        { categorie: '🧠 Filosofisch & persoonlijk' },
        { cmd: 'oordeel over mijn leven: [beschrijving]',            uitleg: 'lof + zorg + eindvonnis' },
        { cmd: 'canoniseer [naam] als heilige van de snackleer',     uitleg: 'heilige daad + heiligendag + patronaat' },
        { cmd: 'geef [naam] een kroket-therapiesessie',              uitleg: 'diagnose + behandelplan + prognose' },
        { cmd: 'onthul de naam van mijn spirit-kroket',              uitleg: 'jouw karakterkroket met profetische implicatie' },
        { cmd: 'wat zou Aristoteles zeggen over de kroket',          uitleg: 'filosofische analyse met deugd, vorm en het Goede' },
        { cmd: 'houd een TED talk over [onderwerp] in kroket',       uitleg: '3-4 alinea\'s met pakkende opening en applauswaardig einde' },
        { cmd: 'stel een kroket-grondwet op',                        uitleg: 'preambule + vijf Artikelen als rechtsregels van de snackleer' },
      ];
