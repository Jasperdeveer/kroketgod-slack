...
const STANDAARD_INSTELLINGEN = {
  ...
  statusMeldingen: true,       // verborgen melding ("only visible to you") bij een statuswijziging
  menties: false,              // @-vermelding onder een spelbericht (nooit voor wie de actie zelf deed)
};
