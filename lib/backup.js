...
const BACKUP_NEGEER = new Set([
  ...
  // Eenmalige beheersingreep: wordt bij gebruik meteen weer gewist. Terugzetten uit een backup zou
  // een al verbruikte uitkomst opnieuw scherp zetten — dat is juist niet de bedoeling.
  'vetbadoverride.json',
]);
